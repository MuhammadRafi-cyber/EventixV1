...
public class PendaftaranDAO {
    ...
    public List<Object[]> getSemuaPesertaPanitia() throws SQLException {
        String sql = "SELECT p.id_pendaftaran, u.nama, u.email, s.judul, p.tanggal_daftar, p.status "
                   + "FROM pendaftaran p "
                   + "JOIN user u ON p.id_pemesan = u.id_user "

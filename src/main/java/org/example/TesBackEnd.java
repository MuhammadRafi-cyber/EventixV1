 ...
 */
public class TesBackEnd {

    // ======================== WIRING ========================
    static final dao.UserDAO userDAO        = new dao.UserDAO();
    static final dao.SeminarDAO seminarDAO     = new dao.SeminarDAO();
    static final dao.PendaftaranDAO pendaftaranDAO = new dao.PendaftaranDAO();
    static final dao.PresensiDAO presensiDAO    = new dao.PresensiDAO();
    static final dao.SertifikatDAO sertifikatDAO  = new dao.SertifikatDAO();
    static final dao.PembayaranDAO pembayaranDAO  = new dao.PembayaranDAO();
    static final dao.InstitusiDAO institusiDAO   = new dao.InstitusiDAO();
    static final dao.KategoriDAO kategoriDAO    = new dao.KategoriDAO();
    static final dao.AuditLogDAO auditLogDAO    = new dao.AuditLogDAO();
    static final dao.LaporanDAO laporanDAO     = new dao.LaporanDAO();

    static final service.PaymentService paymentService =
            new service.DummyPaymentService(pembayaranDAO);

    static final service.AuthService authService        = new service.AuthService(userDAO, auditLogDAO);
    static final service.SeminarService seminarService     = new service.SeminarService(seminarDAO, auditLogDAO);
    static final service.PendaftaranService pendaftaranService = new service.PendaftaranService(
            pendaftaranDAO, seminarDAO, pembayaranDAO, auditLogDAO, paymentService);
    static final service.PresensiService presensiService    = new service.PresensiService(
            presensiDAO, pendaftaranDAO, seminarDAO, auditLogDAO);
    static final service.SertifikatService sertifikatService  = new service.SertifikatService(
            sertifikatDAO, pendaftaranDAO, presensiDAO, auditLogDAO);
    static final service.LaporanService laporanService     = new service.LaporanService(laporanDAO);

    static final controller.AuthController authController        = new controller.AuthController(authService);
    static final controller.SeminarController seminarController     = new controller.SeminarController(seminarService);
    static final controller.PendaftaranController pendaftaranController = new controller.PendaftaranController(pendaftaranService);
    static final controller.PresensiController presensiController    = new controller.PresensiController(presensiService);
    static final controller.SertifikatController sertifikatController  = new controller.SertifikatController(sertifikatService);
    static final controller.LaporanController laporanController     = new controller.LaporanController(laporanService);
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            try {
                if (!controller.AuthController.sudahLogin()) {
                    running = menuAwal();
                } else {
                    model.User user = controller.AuthController.getUserAktif();
                    switch (user.getRole()) {
    ...
    // ======================== MENU PESERTA ========================
    static void menuPeserta(model.User user) {
    ...
    // ======================== MENU PANITIA ========================
    static void menuPanitia(model.User user) {
    ...
    // ======================== MENU ADMIN ========================
    static void menuAdmin(model.User user) {
        System.out.println("""
        \n┌─ MENU ADMIN ──────────────────────────────────────────┐
        │ 1. Semua Seminar                                       │
        │ 2. Tambah Seminar                                      │
    ...
    static void doEditProfil(model.User user) {
    ...
    static void lihatSeminarSaya(model.User panitia) {
    ...
    static void lihatInstitusi() {
        try {
            List<model.Institusi> list = institusiDAO.getAll();
            System.out.println("\n=== DAFTAR INSTITUSI ===");
    ...
    static void lihatKategori() {
        try {
            List<model.Kategori> list = kategoriDAO.getAll();
            System.out.println("\n=== DAFTAR KATEGORI ===");
    ...
    static void doTambahSeminar(model.User panitia) {
    ...
    static void doEditSeminar(model.User panitia) {
    ...
    static void doHapusSeminar(model.User panitia) {
        lihatSeminarSaya(panitia);
    ...
    static void doSelesaikanSeminar(model.User panitia) {
        lihatSeminarSaya(panitia);
    ...
    static void lihatRiwayat(model.User user) {
    ...
    static void lihatDetailTiket() {
        System.out.print("Kode Transaksi: "); String kode = sc.nextLine().trim();
        List<model.DetailPendaftaran> list = pendaftaranController.getDetailTiket(kode);
    ...
    static void doScanPresensi(model.User panitia) {
    ...
    static void lihatSertifikat(model.User user) {
    ...
    static void doEksporLaporanPeserta(model.User user) {
    ...
    static void doEksporLaporanPanitia(model.User user) {
        System.out.print("Path file CSV (Enter=auto): "); String path = sc.nextLine().trim();
